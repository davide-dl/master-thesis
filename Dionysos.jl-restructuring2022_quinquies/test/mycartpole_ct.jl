...
sys1 = ST.NewVarTSystemRK4(f,nsys,SVector(0.0,0.0,0.0,0.0),SVector(0.0),min_tstep,max_tstep)
...
th_left = SVector(x_th,30.0,x_dot_th,theta_dot_th)
...
x_step = 0.4
theta_step = 3.0
x_dot_step = 2*x_dot_th/20
theta_dot_step = 2*theta_dot_th/20
...
C.simulate(sys_rel,xi,T,best_actions,rewards,fig,tstep=0.02,render_each_step=false)
